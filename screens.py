...
def drawDetailWallsScreen(app):
    ...
    drawLabel(f'Wall layers: {app.building.wallsLayers}', 25, app.height-100, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    drawLabel(f'Wall layers R-Values: {app.building.wallsRValue}', 25, app.height-75, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    if isinstance(app.building.wallsRValue, list):
        drawLabel(f'Wall Total R-Value: {pythonRound(sum(app.building.wallsRValue), 2)}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    else:
        drawLabel(f'Wall Total R-Value: {app.building.wallsRValue}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
...
def drawDetailWindowsScreen(app):
    ...
    drawLabel(f'Window layers: {app.building.windowsLayers}', 25, app.height-100, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    drawLabel(f'Window layers R-Values: {app.building.windowsRValue}', 25, app.height-75, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    if isinstance(app.building.windowsRValue, list):
        drawLabel(f'Window Total R-Value: {pythonRound(sum(app.building.windowsRValue), 2)}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    else:
        drawLabel(f'Window Total R-Value: {app.building.windowsRValue}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
...
def drawDetailDoorsScreen(app):
    ...
    drawLabel(f'Door layers: {app.building.doorsLayers}', 25, app.height-100, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    drawLabel(f'Door layers R-Values: {app.building.doorsRValue}', 25, app.height-75, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    if isinstance(app.building.doorsRValue, list):    
        drawLabel(f'Door Total R-Value: {pythonRound(sum(app.building.doorsRValue), 2)}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    else:
        drawLabel(f'Door Total R-Value: {app.building.doorsRValue}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
...
def drawDetailFloorsScreen(app):
    ...
    drawLabel(f'Floor layers: {app.building.floorsLayers}', 25, app.height-100, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    drawLabel(f'Floor layers R-Values: {app.building.floorsRValue}', 25, app.height-75, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    if isinstance(app.building.floorsRValue, list): 
        drawLabel(f'Floor Total R-Value: {pythonRound(sum(app.building.floorsRValue), 2)}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    else:
        drawLabel(f'Floor Total R-Value: {app.building.floorsRValue}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
...
def drawDetailRoofsScreen(app):
    ...
    drawLabel(f'Roof layers: {app.building.roofsLayers}', 25, app.height-100, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    drawLabel(f'Roof layers R-Values: {app.building.roofsRValue}', 25, app.height-75, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    if isinstance(app.building.roofsRValue, list): 
        drawLabel(f'Roof Total R-Value: {pythonRound(sum(app.building.roofsRValue), 2)}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
    else:
        drawLabel(f'Roof Total R-Value: {app.building.roofsRValue}', 25, app.height-50, size=app.textSizeSmall, fill='white', font=app.font, align='left', bold = True)
...
def draw3CalculateScreen(app):
    ...
    print(app.building.totalWindowArea)
    print(app.building.totalWallArea)
    print(app.building.totalDoorArea)
    print(app.building.totalFloorArea)
    print(app.building.totalRoofArea)
